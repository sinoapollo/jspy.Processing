...
function runPyProcessing(pyprocessingcode)
{
	...
	html1 = '<head><title>jspy.Processing</title><meta charset="UTF-8"><meta name="viewport" content="width=device-width; initial-scale=1.0; minimum-scale=1.0; maximum-scale=1.0"/><base href="' +
			window.location + '"><meta http-equiv="Access-Control-Allow-Origin" content="*" /><meta http-equiv="Access-Control-Allow-Methods" content="*" /><script language="javascript" type="text/javascript" src="p5/p5.js"></script' +
			...
			'><style> body {padding: 0; margin: 0;} </style></head><body onload="brython()"><script type="text/python">\
